...
const GPTsearchBar=()=>{
    const dispatch=useDispatch();
     ...
     const handleGPTsearch = async () => {
       ...
       const gptResult=['airplane!', 'anchorman: the legend of ron burgundy', 'napoleon dynamite', 'zoolander', 'superbad'];
    ...
    return (
        ...
        <div className="w-1/2 mx-auto mt-[45%] md:mt-[8%] sm:mt-[12%] ">
            <form className="grid grid-cols-12 " onSubmit={(e)=>(e.preventDefault())}>
                ...
                <button className="bg-red-500 p-4 col-span-5 sm:col-span-3 rounded-lg ml-2  md:text-2xl" onClick={handleGPTsearch}>{languages[lang].search}</button>
            </form>
        </div>
