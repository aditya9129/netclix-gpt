const Videotitle=({name,overview})=>{
    ...
    return (
        ...
        //     <h1 className=" mt-80 text-4xl font-bold">{name}</h1> 
        //     <p className="w-1/6 font-bold">{overview}</p>
        //     <div className="flex ">
        //     <button className="bg-white text-black rounded-lg w-24 p-3 my-3 flex font-bold hover:bg-slate-300"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-play-fill" viewBox="0 0 16 16">
        //                             <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
        //     </svg>Play</button>
        //     <button className="bg-white text-black rounded-lg  p-3 m-3 flex font-bold hover:bg-slate-300">  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-info-circle-fill mr-2" viewBox="0 0 16 16">
